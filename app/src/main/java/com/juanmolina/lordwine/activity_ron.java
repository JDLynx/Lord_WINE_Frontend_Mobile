...
public class activity_ron extends AppCompatActivity {

    private RecyclerView recyclerViewRones;
    private ProgressBar progressBarLoading;
    private TextView textViewStatusMessage;
    private ProductosAdapter productosAdapter;
    private List<Producto> listaRones;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerViewRones = findViewById(R.id.recyclerViewRones);
        progressBarLoading = findViewById(R.id.progressBarLoading);
        textViewStatusMessage = findViewById(R.id.textViewStatusMessage);

        bottomNavigationView = findViewById(R.id.bottom_navigation_ron);
        drawerLayout = findViewById(R.id.drawer_layout_ron);
        navigationView = findViewById(R.id.nav_view_ron);

        categoriesList = new ArrayList<>();
        allProductsList = new ArrayList<>();

        listaRones = new ArrayList<>();
        productosAdapter = new ProductosAdapter(this, listaRones);

        recyclerViewRones.setLayoutManager(new GridLayoutManager(this, 2));
        recyclerViewRones.setAdapter(productosAdapter);
        ...
        call.enqueue(new Callback<List<Producto>>() {
            ...
            public void onResponse(Call<List<Producto>> call, Response<List<Producto>> response) {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    filterAndShowProducts(allProductsList, "Ron");
                } else {
    ...
    private void filterAndShowProducts(List<Producto> productosData, String categoryName) {
        ...
        if (productosFiltrados.isEmpty()) {
            ...
            textViewStatusMessage.setVisibility(View.VISIBLE);
            recyclerViewRones.setVisibility(View.GONE);
        } else {
            listaRones.clear();
            listaRones.addAll(productosFiltrados);
            productosAdapter.notifyDataSetChanged();
            recyclerViewRones.setVisibility(View.VISIBLE);
            textViewStatusMessage.setVisibility(View.GONE);
        }
    }
